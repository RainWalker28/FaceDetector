...
from gender_prediction import emotion,ageAndgender,emotionvideo
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button5 = tk.Button(self, text="Landmark Prediction", command=self.landmark, fg="#ffffff",bg="#263942")
        button6 = tk.Button(self, text="Video Emotion", command=self.emotionvideo, fg="#ffffff", bg="#263942")
        button1.grid(row=1,column=0, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
        button2.grid(row=3,column=0, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
        ...
        button5.grid(row=2, column=1, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
        button6.grid(row=3, column=1, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
